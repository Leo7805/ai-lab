...
A lightweight **Text‑to‑Speech (TTS)** module built with **.NET 10 Web API** and **React + Vite + MUI**.  
...
- NuGet Package
  1. `Swashbukle`
  1. `Microsoft.CognitiveServices.Speech`
...
- Node.js Package
  1. `MUI`. npm i @mui/material @emotion/react @emotion/styled @mui/icons-material
